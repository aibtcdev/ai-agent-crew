...
class StacksM2MTools:
    ...
    def get_recent_payment_data(address: str):
        ...
        return BunScriptRunner.bun_run("stacks-m2m-v2", "get-recent-payments.ts", address)
    ...
    def get_user_data_by_address(address: str):
        ...
        return BunScriptRunner.bun_run("stacks-m2m-v2", "get-user-data-by-address.ts", address)
